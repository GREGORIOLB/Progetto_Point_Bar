...
public class BarPos {
	...
	public void paga(double importo) {
		if (importo >= totale) {
			...
			System.out.println("Pagamento effettuato! Grazie e buona giornata!");
			System.out.println("Resto: " + resto);
			prodotti.clear();
			totale = 0;
		} else {
			System.out.println("Importo insufficiente! Pagamento non accettato.");
		}
	}

	public static void main(String[] args) {
		// istanza di pos
		BarPos pos = new BarPos();
		Scanner input = new Scanner(System.in);

		System.out.println("Benvenuti al bar di BitCamp!");
		System.out.println("Seleziona la tua scelta");
		while (true) {
